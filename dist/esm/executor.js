import { AsyncGeneratorFunction, CodeString, DelayedSynchronousResult, GeneratorFunction, LispType, LocalScope, NON_BLOCKING_THRESHOLD, Prop, SandboxAccessError, SandboxCapabilityError, SandboxError, SandboxExecutionQuotaExceededError, SandboxExecutionTreeError, Scope, VarType, hasOwnProperty, isLisp } from "./utils.js";
...
addOps(LispType.Prop, ({ done, a, b, obj, context, scope, internal }) => {
	...
	const g = obj instanceof Prop && obj.isGlobal || typeof a === "function" && !context.ctx.sandboxedFunctions.has(a) || context.ctx.globalsWhitelist.has(a);
...
//#endregion
export { ExecReturn, If, KeyVal, SpreadArray, SpreadObject, YieldValue, addOps, assignCheck, asyncDone, createAsyncGeneratorFunction, createFunction, createFunctionAsync, createGeneratorFunction, execAsync, execMany, execSync, executeTree, executeTreeAsync, ops, syncDone };
