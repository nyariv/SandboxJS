import { SandboxExecutionQuotaExceededError, SandboxHaltError } from "../utils/errors.js";
...
function checkTicksAndThrow(ctx, expectTicks) {
	const { ticks } = ctx;
	if (ticks.tickLimit !== void 0 && ticks.tickLimit <= ticks.ticks + expectTicks) throw new SandboxHaltError(new SandboxExecutionQuotaExceededError("Execution quota exceeded"));
