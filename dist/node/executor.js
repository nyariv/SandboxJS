...
exports.executeTreeAsync = exports.executeTree = exports.sandboxedSetInterval = exports.sandboxedSetTimeout = exports.sandboxedEval = exports.createFunctionAsync = exports.createFunction = exports.sandboxFunction = exports.SandboxError = exports.Scope = exports.Prop = exports.ExecReturn = void 0;
...
let ops2 = {
    ...
    'call': (exec, done, a, b, obj, context, scope) => {
        ...
        const args = b.map((item) => {
            if (item instanceof parser_js_1.SpreadArray) {
                return [...item.item];
            }
            else {
                return [item];
    ...
    'createObject': (exec, done, a, b, obj, context, scope) => {
        let res = {};
        for (let item of b) {
            if (item instanceof parser_js_1.SpreadObject) {
                res = { ...res, ...item.item };
            }
            else {
    ...
    'keyVal': (exec, done, a, b) => done(undefined, new parser_js_1.KeyVal(a, b)),
    ...
    'spreadArray': (exec, done, a, b, obj, context, scope) => {
        exec(b, scope, context, (err, res) => {
            ...
            done(undefined, new parser_js_1.SpreadArray(res));
        });
    },
    'spreadObject': (exec, done, a, b, obj, context, scope) => {
        exec(b, scope, context, (err, res) => {
            ...
            done(undefined, new parser_js_1.SpreadObject(res));
        });
    },
    ...
    '&': (exec, done, a, b) => done(undefined, a & b),
    '|': (exec, done, a, b) => done(undefined, a | b),
    ':': (exec, done, a, b) => done(undefined, new parser_js_1.If(a, b)),
    '+': (exec, done, a, b) => done(undefined, a + b),
    '-': (exec, done, a, b) => done(undefined, a - b),
    '$+': (exec, done, a, b) => done(undefined, +b),
    '$-': (exec, done, a, b) => done(undefined, -b),
